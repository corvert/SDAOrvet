...
public class BinarySearchTree {
    ...
    parent is alreadu filled, creates a New Node with data and calls the add (parnet, newNode) to find the right
    root and add ot to it
    @param data
     */
    ...
    public void traverseLeft(){
        Node current = parent;
        System.out.println("Traverse the BST From Left : ");
        while (current.left != null && current.right != null){
            System.out.println(current.data + "->[" + current.left.data + " " + current.right.data + "] ");
    ...
    public void traverseRight(){
        Node current = parent;
        System.out.println("Traverse the BST From Right");
        while (current.left != null && current.right != null){
            System.out.println(current.data + "->[" + current.left.data + " " + current.right.data + "] ");
